...
const Login = () => {
    ...
    signIn(email, password)
      ...
      .catch((error) => {
        ...
        if(error.message.includes('user-not-found')){
          setError("We did not find your account! Please check if you entered your email address correctly. If you are new to this site Please Register");
        }
  ...
  return (
          ...
          >
            ...
            <div className="mt-8 flex flex-col gap-y-4">
              ...
              <div className="mt-8 flex justify-center items-center">
                <p className="font-medium text-lg">New to this site?</p>
    ...
    //       </div>
    //       <div className="mt-8 flex flex-col gap-y-4">
    //         <button className=" active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-teal-500 rounded-xl text-white font-bold text-lg">
    //           Sign in
    //         </button>
